...
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_stream_G2M.png", figsize=(7,5), size = 50, legend_fontsize = 12, show=False, color='G2M_score', title='')
...
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_stream_S.png", figsize=(7,5), size = 50, legend_fontsize = 12, show=False, color='S_score', title='')
...
scv.tl.velocity_embedding(adata2, basis = 'PCA_alevin_spliced', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_PCA_alevin_spliced'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_PCA_alevin_spliced.csv")
scv.tl.velocity_embedding(adata2, basis = 'TSNE_alevin_spliced', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_TSNE_alevin_spliced'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_TSNE_alevin_spliced.csv")
