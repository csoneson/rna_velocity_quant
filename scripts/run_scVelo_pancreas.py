...
scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream_G2M.png", figsize=(7,5), size = 50, legend_fontsize = 12, show=False, color='G2M_score', title='')
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced_gentrome', save="UMAP_alevin_spliced_gentrome_stream_G2M.png", figsize=(7,5), size = 50, legend_fontsize = 12, show=False, color='G2M_score', title='')

scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream_S.png", figsize=(7,5), size = 50, legend_fontsize = 12, show=False, color='S_score', title='')
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced_gentrome', save="UMAP_alevin_spliced_gentrome_stream_S.png", figsize=(7,5), size = 50, legend_fontsize = 12, show=False, color='S_score', title='')
...
scv.tl.velocity_embedding(adata2, basis = 'PCA_alevin_spliced_gentrome', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_PCA_alevin_spliced_gentrome'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_PCA_alevin_spliced_gentrome.csv")
scv.tl.velocity_embedding(adata2, basis = 'TSNE_alevin_spliced_gentrome', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_TSNE_alevin_spliced_gentrome'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_TSNE_alevin_spliced_gentrome.csv")
...
scv.tl.velocity_embedding(adata2, basis = 'PCA_starsolo', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_PCA_starsolo'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_PCA_starsolo.csv")
scv.tl.velocity_embedding(adata2, basis = 'TSNE_starsolo', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_TSNE_starsolo'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_TSNE_starsolo.csv")
scv.tl.velocity_embedding(adata2, basis = 'UMAP_starsolo', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_UMAP_starsolo'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_UMAP_starsolo.csv")

scv.tl.velocity_embedding(adata2, basis = 'PCA_starsolo_concatenated', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_PCA_starsolo_concatenated'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_PCA_starsolo_concatenated.csv")
scv.tl.velocity_embedding(adata2, basis = 'TSNE_starsolo_concatenated', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_TSNE_starsolo_concatenated'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_TSNE_starsolo_concatenated.csv")
scv.tl.velocity_embedding(adata2, basis = 'UMAP_starsolo_concatenated', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_UMAP_starsolo_concatenated'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_UMAP_starsolo_concatenated.csv")

scv.tl.velocity_embedding(adata2, basis = 'PCA_starsolo_summed', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_PCA_starsolo_summed'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_PCA_starsolo_summed.csv")
scv.tl.velocity_embedding(adata2, basis = 'TSNE_starsolo_summed', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_TSNE_starsolo_summed'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_TSNE_starsolo_summed.csv")
scv.tl.velocity_embedding(adata2, basis = 'UMAP_starsolo_summed', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_UMAP_starsolo_summed'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_UMAP_starsolo_summed.csv")

scv.tl.velocity_embedding(adata2, basis = 'PCA_starsolo_unspliced', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_PCA_starsolo_unspliced'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_PCA_starsolo_unspliced.csv")
scv.tl.velocity_embedding(adata2, basis = 'TSNE_starsolo_unspliced', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_TSNE_starsolo_unspliced'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_TSNE_starsolo_unspliced.csv")
scv.tl.velocity_embedding(adata2, basis = 'UMAP_starsolo_unspliced', all_comps = False, autoscale = False)
pd.DataFrame(adata2.obsm['velocity_UMAP_starsolo_unspliced'], index = adata2.obs.index).to_csv(plotdir + "/" + base + basegs + "/" + base + basegs + "_velocity_UMAP_starsolo_unspliced.csv")
...
try:
	...
	scv.pl.velocity(adata2, var_names=ret_genes, save="genes_from_paper_velocity.png", basis='UMAP_alevin_spliced_gentrome', show=False)
	...
	scv.pl.velocity(adata2, var_names=ret_genes, save="genes_of_interest_velocity.png", basis='UMAP_alevin_spliced_gentrome', show=False)
