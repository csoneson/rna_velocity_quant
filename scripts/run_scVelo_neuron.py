...
scv.pl.velocity_embedding_stream(adata2, basis='X_pca', save="PCA_stream.png", figsize=(12,9), show=False, color='cluster', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='X_tsne', save="TSNE_stream.png", figsize=(12,9), show=False, color='cluster', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream.png", figsize=(12,9), show=False, color='cluster', title=mname)

scv.pl.velocity_embedding_stream(adata2, basis='PCA_velocyto_concatenated', save="PCA_velocyto_concatenated_stream.png", figsize=(12,9), show=False, color='cluster_velocyto_concatenated', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='TSNE_velocyto_concatenated', save="TSNE_velocyto_concatenated_stream.png", figsize=(12,9), show=False, color='cluster_velocyto_concatenated', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_velocyto_concatenated', save="UMAP_velocyto_concatenated_stream.png", figsize=(12,9), show=False, color='cluster_velocyto_concatenated', title=mname)

scv.pl.velocity_embedding_stream(adata2, basis='PCA_alevin_spliced', save="PCA_alevin_spliced_stream.png", figsize=(12,9), show=False, color='cluster_alevin_spliced', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='TSNE_alevin_spliced', save="TSNE_alevin_spliced_stream.png", figsize=(12,9), show=False, color='cluster_alevin_spliced', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_stream.png", figsize=(12,9), show=False, color='cluster_alevin_spliced', title=mname)
