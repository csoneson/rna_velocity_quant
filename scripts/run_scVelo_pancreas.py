...
scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream_G2M.png", figsize=(12,9), show=False, color='G2M_score', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_velocyto_concatenated', save="UMAP_velocyto_concatenated_stream_G2M.png", figsize=(12,9), show=False, color='G2M_score', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_stream_G2M.png", figsize=(12,9), show=False, color='G2M_score', title=mname)

scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream_S.png", figsize=(12,9), show=False, color='S_score', title=mname)
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_velocyto_concatenated', save="UMAP_velocyto_concatenated_stream_S.png", figsize=(12,9), show=False, color='S_score', title=mname)
