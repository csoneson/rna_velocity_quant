...
scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream_G2M.png", figsize=(12,9), show=False, color='G2M_score')
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_velocyto_concatenated', save="UMAP_velocyto_concatenated_stream_G2M.png", figsize=(12,9), show=False, color='G2M_score')
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_stream_G2M.png", figsize=(12,9), show=False, color='G2M_score')

scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream_S.png", figsize=(12,9), show=False, color='S_score')
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_velocyto_concatenated', save="UMAP_velocyto_concatenated_stream_S.png", figsize=(12,9), show=False, color='S_score')
scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_stream_S.png", figsize=(12,9), show=False, color='S_score')
...
#scv.pl.velocity_embedding(adata2, basis='X_umap', save="UMAP.png", figsize=(12,9), show=False, color='cluster')
#scv.pl.velocity_embedding(adata2, basis='PCA_velocyto_concatenated', save="PCA_velocyto_concatenated.png", figsize=(12,9), show=False, color='cluster_velocyto_concatenated')
#scv.pl.velocity_embedding(adata2, basis='TSNE_velocyto_concatenated', save="TSNE_velocyto_concatenated.png", figsize=(12,9), show=False, color='cluster_velocyto_concatenated')
#scv.pl.velocity_embedding(adata2, basis='UMAP_velocyto_concatenated', save="UMAP_velocyto_concatenated.png", figsize=(12,9), show=False, color='cluster_velocyto_concatenated')
#scv.pl.velocity_embedding(adata2, basis='PCA_alevin_spliced', save="PCA_alevin_spliced.png", figsize=(12,9), show=False, color='cluster_alevin_spliced')
...
scv.pl.velocity_graph(adata2, basis='UMAP_alevin_spliced', save='UMAP_alevin_spliced_velocitygraph.png', figsize=(12,9), show=False, color='clusters')
...
try:
	...
	scv.pl.velocity_embedding_stream(adata2, basis='X_umap', save="UMAP_stream_latent_time.png", figsize=(12,9), show=False, color='latent_time')
	scv.pl.velocity_embedding_stream(adata2, basis='UMAP_velocyto_concatenated', save="UMAP_velocyto_concatenated_stream_latent_time.png", figsize=(12,9), show=False, color='latent_time')
	scv.pl.velocity_embedding_stream(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_stream_latent_time.png", figsize=(12,9), show=False, color='latent_time')
	scv.pl.scatter(adata2, basis='UMAP_alevin_spliced', save="UMAP_alevin_spliced_latent_time.png", figsize=(12,9), size=100, show=False, color='latent_time', color_map='gnuplot', perc=[2,98], rescale_color=[0,1])
except:
...
try:
	...
	scv.pl.scatter(adata2, basis=ret_genes, legend_loc='none', size=80, frameon=False, ncols=5, fontsize=20, save="genes_of_interest_scatter.png", show=False)
	scv.pl.velocity(adata2, var_names=ret_genes, save="genes_of_interest_velocity.png", basis='UMAP_alevin_spliced', show=False)
	scv.pl.scatter(adata2, x='latent_time', y=ret_genes, legend_loc='none', size=80, n_convolve=None, frameon=False, save="genes_of_interest_vs_latent_time.png", show=False)
except:
